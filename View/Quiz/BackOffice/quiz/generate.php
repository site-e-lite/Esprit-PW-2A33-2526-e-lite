...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!empty($result['success'])) {
        header('Location: ' . $__bp . '/quiz/admin?generated=1');
        exit;
    }
...
<body>
    <aside class="admin-sidebar">
        ...
        <ul class="admin-nav">
            ...
            <li><a href="<?= $__bp ?>/quiz/admin/generer" class="active"><i class="fas fa-wand-magic-sparkles"></i> Generer un Quiz</a></li>
    ...
    <main class="admin-content">
        <a href="<?= $__bp ?>/quiz/admin" class="back-link"><i class="fas fa-arrow-left"></i> Retour a la liste des quiz</a>
