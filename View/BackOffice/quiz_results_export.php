...
<aside class="admin-sidebar">
    ...
    <ul class="admin-nav">
        ...
        <li><a href="quiz_results_export.php" class="active"><i class="fas fa-file-export"></i> Export Google Sheets</a></li>
...
<main class="admin-content">
    <div class="page-header">
        ...
        <div class="toolbar">
            <a href="quizzes_list.php" class="button secondary"><i class="fas fa-arrow-left"></i> Retour</a>
    ...
    <section class="card">
        <form id="exportForm" method="get" action="quiz_results_export.php">
            <div class="filters">
            ...
            <div style="display:flex; gap:0.75rem; flex-wrap:wrap;">
                ...
                <a href="quiz_results_export.php" class="button secondary"><i class="fas fa-rotate-left"></i> Réinitialiser</a>
            </div>
        </form>
...
document.getElementById('exportButton').addEventListener('click', async function() {
    ...
    try {
        const response = await fetch('quiz_results_export.php?' + params.toString(), {
            method: 'GET'
        });
