...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($titre !== '' && $duree > 0 && $seuilReussite >= 0 && $seuilReussite <= 100 && $niveau !== '' && $idCourse > 0) {
...
<body>
    ...
    <main class="admin-content">
        ...
        <div class="form-card">
            ...
            <form id="quizAddForm" action="" method="POST" onsubmit="return validateQuizForm(this)">
                <div class="field-group" id="fg-titre">
                    <label for="titre">Titre</label>
                    <input type="text" id="titre" name="titre" maxlength="100" placeholder="Titre du quiz">
                    <div class="field-msg" id="titre-msg"></div>
                </div>

                <div class="field-group" id="fg-duree">
                    <label for="duree">Durée (minutes)</label>
                    <input type="number" id="duree" name="duree" min="1" placeholder="Ex: 20">
                ...
                <div class="field-group" id="fg-seuilReussite">
                    ...
                    <input type="number" id="seuilReussite" name="seuilReussite" min="0" max="100" placeholder="0 à 100">
                ...
                <div class="field-group" id="fg-idCourse">
                    ...
                    <input type="number" id="idCourse" name="idCourse" min="1" placeholder="Ex: 1">
