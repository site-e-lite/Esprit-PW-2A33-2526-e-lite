...
if (isset($_GET['unlock_lock'])) {
    ...
    header('Location: quiz_locks.php?unlocked=1');
    exit;
}
...
<aside class="admin-sidebar">
    ...
    <ul class="admin-nav">
        ...
        <li><a href="quiz/generate.php"><i class="fas fa-wand-magic-sparkles"></i> Generer un Quiz</a></li>
        <li><a href="quiz_locks.php" class="active"><i class="fas fa-lock"></i> Verrous Quiz</a></li>
                ...
                <?php if ($locks && $locks->rowCount() > 0): ?>
                    <?php while ($lock = $locks->fetch()): ?>
                        <tr>
                            ...
                            <td><a class="unlock-btn" href="quiz_locks.php?unlock_lock=<?= htmlspecialchars($lock['idLock']) ?>">Deverrouiller</a></td>
                        </tr>
                    <?php endwhile; ?>
                <?php else: ?>
                    <tr>
