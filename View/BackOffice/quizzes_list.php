...
<div class="confirm-overlay" id="confirmOverlay">
    <div class="confirm-box">
        ...
        <p>Cette action est irréversible. Les questions liées seront conservees et simplement detachees du quiz.</p>
    ...
    <aside class="admin-sidebar">
        ...
        <ul class="admin-nav">
            ...
            <li><a href="quiz_locks.php"><i class="fas fa-lock"></i> Verrous Quiz</a></li>
    ...
    <main class="admin-content">
        <header class="admin-header reveal">
            ...
            <div style="display:flex; gap:0.8rem;">
                <a href="quiz/generate.php" class="add-btn" style="background: linear-gradient(135deg, #22c55e, #16a34a);"><i class="fas fa-wand-magic-sparkles"></i> Generer un Quiz</a>
                <a href="quiz_results_export.php" class="add-btn" style="background: linear-gradient(135deg, #22c55e, #15803d);"><i class="fas fa-file-export"></i> Exporter vers Google Sheets</a>
                <a href="quiz_locks.php" class="add-btn" style="background: linear-gradient(135deg, #f59e0b, #d97706);"><i class="fas fa-lock"></i> Verrous Quiz</a>
                    ...
                    <?php if ($quizs && $quizs->rowCount() > 0): ?>
                        <?php while ($q = $quizs->fetch()): ?>
                            <tr>
                                ...
                                <td><?= htmlspecialchars($quizController->getCourseTitleById($q['idCourse'])) ?></td>
                                ...
                                <td>
                                    ...
                                    <a href="questions_list.php" class="action-btn" title="Voir les questions"><i class="fas fa-question-circle"></i></a>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (p.get('generated') === '1') showToast('Quiz genere automatiquement avec succes !');
