...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (!$questionController->validateQuestion($_POST)) {
        ...
        header('Location: ' . $__bp . '/quiz/admin/questions?updated=1');
        exit;
    }
}
?>
        ...
        <div class="form-card">
            ...
            <?php else: ?>
                <div style="padding: 3rem 1rem; text-align:center; color:rgba(255,255,255,0.5);">
                    ...
                    <a href="<?= $__bp ?>/quiz/admin/questions" class="submit-btn" style="width:auto; padding:0.75rem 1.5rem; text-decoration:none;">Retour à la liste</a>
                </div>
            <?php endif; ?>
        </div>
    </main>
...
(function() {
    ...
    window.ensureQuestionResponseRows = function() { ensureMinRows(2); };
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Binder les boutons supprimer sur les rows déjà présentes (chargées depuis DB)
